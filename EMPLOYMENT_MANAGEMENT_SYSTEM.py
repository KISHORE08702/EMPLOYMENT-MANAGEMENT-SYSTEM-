...
def update_employee(emp_id,name=None,age=None,salary=None,department=None):
    ...
    try:
        if emp_id in employees:
            ...
            print(f"Employee {emp_id} updated Sucessfully...!")    

        else:
            print(f"Empolyee with id {emp_id} Not found")

    except KeyError as e:
        print(f"Error updating employee Detail:{e}")
...
def remove_employee(emp_id):
    ...
    try:
        ...
        print(f"Employee {emp['Name']} Removed Sucessfully...!")

    except KeyError:

        print(f"Employee with Id {emp_id} not found")

#Function to save employee data without JSON
...
def save_to_file(filename):
    ...
    try:
        ...
        print("Employee data saved Sucessfully....!")
...
def load_from_file(filename):
    try:
        ...
        print("Employee data loaded sucessfully....")
